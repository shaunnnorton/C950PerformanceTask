...
from Utils.packageSelection import selectPackage, getDeadline
...
class Delivery():
                ...
                if len(truck._PACKAGES[route-1]) < 16:
                    ...
                    if avalible:
                        if len(group_add) > 0:
                            ...
                            package.TRANSIT_TIME = departureTime
    ...
    def distanceToHub(self, truck: Truck, route: int) -> float:
        ...
        truck.routes[0].append(distance)
    ...
    def createRoute(self, truck:Truck, route: int):
        ...
        for package in truck._PACKAGES[route]:
        ...
        for package in deadlined_packages.get_packages():
            if selectPackage.get_deadline(package) < soonest:
        ...
        if first_package == None:
            address = self.unassigned_packages.addresses[0].Street
