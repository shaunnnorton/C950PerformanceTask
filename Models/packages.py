...
class Packages():
    ...
    def search_packages(self,id: int) -> tuple:
        ...
        return [] #return an empty list if no Package is found
    ...
    def calculate_bucket(id):
        """Calculatest the bucket in the hash table using an id"""
        return self.packages % self.hash_buckets # Take the Mod of the id and the amount of buckets. 
